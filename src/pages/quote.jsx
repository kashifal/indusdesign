...
export default function Login() {
  ...
  return (
    <>
      ...
      <div className={message ? "rounded-md bg-green-100 fixed top-0 w-full p-4" : 'hidden'}>
      <div className="flex items-center">
        <div className="flex-shrink-0">
          <CheckCircleIcon className="h-5 w-5 text-green-700" aria-hidden="true" />
        </div>
        <div className="ml-3">
          <p className="text-sm font-medium text-green-800">Successfully Sent. Check Your Inbox</p>
        </div>
      ...
      <AuthLayout title="Ask us for anything - Price / Time" subtitle={<></>}>
