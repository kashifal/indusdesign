  ...
  return (
    <>
      ...
      <main>
        ...
        >
          <div className="h-5 w-5 absolute animate-bounce rounded-full flex items-center justify-center -top-2 right-2 ring-1 ring-blue-600 bg-white text-blue-600 text-xs
          ">1</div>
          <svg
