  ...
  return (
    <>
      ...
      <main>
        ...
        <a
          href="https://github.com/kashifal/induscode"
          className="fixed bottom-8 text-white  right-8 z-50 flex items-center gap-2 rounded-full  px-3 py-3 font-semibold ring-1 ring-transparent duration-300 bg-gray-700"
        >
          
            Contribute : induscode
        </a>


        <a
          href="mailto:ikashif@indusappps.com"
          className="fixed bottom-8  right-60 z-50 flex items-center gap-2 rounded-full  px-3 py-3 font-semibold ring-1 ring-transparent duration-300 bg-pink-600"
        >
