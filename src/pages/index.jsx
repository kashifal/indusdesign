...
export default function Home() {
  return (
    <>
      <Head>
        <title>Indues D. - Hire Designers / Developers</title>
        <meta
          name="description"
      ...
      <main>
        ...
        <a
          ...
          className="fixed bottom-8 right-8 z-50 flex hover:bg-emerald-600 font-semibold duration-300 items-center gap-2 rounded-md bg-black px-8 py-3 ring-1 ring-transparent"
        >
          <svg
          ...
          <span className="text-white">Talk to Developers</span>
        </a>
        <Reviews />
        <Team />
        <Pricing />
