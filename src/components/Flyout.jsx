          ...
          <div className="w-screen max-w-md flex-auto overflow-hidden rounded-3xl bg-white text-sm leading-6 shadow-lg ring-1 ring-gray-900/5 lg:max-w-3xl">
              ...
              {solutions.map((item) => (
                <div key={item.name} className="group relative flex gap-x-6 rounded-lg p-4 hover:bg-gray-50">
                  <div className="mt-1 flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                    <item.icon className="h-6 w-6 text-gray-600 group-hover:text-lime-600" aria-hidden="true" />
                  </div>
                  <div>
            ...
            <div className="bg-gray-50 px-8 py-6">
              <div className="flex items-center gap-x-3">
                ...
                <p className="rounded-full bg-lime-600/10 px-2.5 py-1.5 text-xs font-semibold text-lime-600">New</p>
              </div>
