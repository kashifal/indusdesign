      ...
      >
        
        {
            sliders.map(({title, link, desc, tags, img}) => (
                <SwiperSlide >
                <div className="h-32 w-full border-2 border-lime-300">
                <img className="object-cover" src={img} alt="" />
                     ...
                     <div className="px-2 py-1  text-left">
                          ...
                          <a href={link} className="text-sm flex items-center gap-2 parent font-medium  px-2 text-lime-600 rounded-full"> <LinkIcon className="h-4 w-4" /> {title} <ArrowRightIcon className="h-4 w-4 " /></a>
                     ...
                     <div className="mr-auto px-2 mt-2 flex gap-4 items-center ">
                        {
                            tags?.map((tag, index) => (
                                ...
                                <span key={index} className="px-2 py-1 bg-lime-100 rounded-full text-xs text-lime-600" >{tag}</span>
                            ))
                        }
