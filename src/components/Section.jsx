  ...
  <ul className="-my-2">
    ...
    <li className="relative py-2">
      <div className="mb-1 flex items-start">
        <div className="absolute left-0 ml-[28px] h-full w-px -translate-x-1/2 translate-y-3 self-start bg-slate-200 dark:bg-slate-800" aria-hidden="true"></div>
        <div className="absolute left-0 flex h-14 w-14 items-center justify-center rounded-full border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 dark:bg-gradient-to-t dark:from-slate-800 dark:to-slate-800/30">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16">
            <path fill="#DE4D3B" d="M15.912 6.545h-7.75v3.273h4.393c-.702 2.182-2.437 2.91-4.428 2.91-2.12.002-3.992-1.368-4.601-3.37a4.693 4.693 0 0 1 1.959-5.307 4.854 4.854 0 0 1 5.722.33l2.414-2.265C10.947-.31 6.964-.69 3.867 1.186.771 3.06-.683 6.735.308 10.18c.99 3.445 4.185 5.822 7.819 5.82 4.477 0 8.525-2.91 7.785-9.456Z" />
          </svg>
        </div>
        <div className="space-y-1 pl-20">
          <div className="text-xs uppercase text-slate-500">May 2020 <span className="text-slate-400 dark:text-slate-600">·</span> Present</div>
      ...
      <div className="mb-1 flex items-start">
        ...
        <div className="absolute left-0 flex h-14 w-14 items-center justify-center rounded-full border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 dark:bg-gradient-to-t dark:from-slate-800 dark:to-slate-800/30">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="12">
            <path className="fill-slate-800 dark:fill-slate-100" d="M5.64 0c3.116 0 5.641 2.686 5.641 6s-2.525 6-5.64 6C2.526 12 0 9.314 0 6c0-3.313 2.525-6 5.64-6Zm9.008.351c1.558 0 2.82 2.53 2.82 5.65h.001c0 3.118-1.263 5.648-2.82 5.648-1.558 0-2.82-2.53-2.82-5.649S13.09.351 14.648.351Zm4.36.589C19.556.94 20 3.205 20 6c0 2.794-.444 5.06-.992 5.06s-.992-2.265-.992-5.06c0-2.794.444-5.06.992-5.06Z" />
          </svg>
        </div>
        <div className="space-y-1 pl-20">
          <div className="text-xs uppercase text-slate-500">May 2017 <span className="text-slate-400 dark:text-slate-600">·</span> Apr 2020</div>
          <div className="font-aspekta font-[650] text-slate-800 dark:text-slate-100">Senior Front-end Engineer</div>
    ...
    <li className="relative py-2">
      <div className="mb-1 flex items-start">
        ...
        <div className="space-y-1 pl-20">
          <div className="text-xs uppercase text-slate-500">Feb 2016 <span className="text-slate-400 dark:text-slate-600">·</span> Dec 2016</div>
