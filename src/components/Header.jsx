      ...
      <nav className='shadow-sm '>
        <Container className="relative z-50 flex justify-between  h-16">
          ...
          <div className="flex items-center gap-6">
            ...
            <a className="text-sm hidden lg:block px-2 py-2 text-lime-500 bg-lime-100 rounded-md  border-lime-500 border font-semibold" href="tel:ikashif@indusappps.com">
            ...
            <a className="text-sm hidden lg:block px-2 py-2   rounded-md text-lime-600 font-semibold" href="mailto:ikashif@indusappps.com">ikashif@indusappps.com</a>
