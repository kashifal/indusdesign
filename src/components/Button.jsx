...
const variantStyles = {
  solid: {
    ...
    white:
      'bg-white text-lime-900 hover:bg-white/90 active:bg-white/90 active:text-lime-900/70',
    gray: 'bg-lime-500 text-white hover:bg-lime-700 active:bg-lime-700 active:text-white/80',
  },
  outline: {
